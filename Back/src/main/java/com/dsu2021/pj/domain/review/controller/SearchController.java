...
public class SearchController {
	...
	public ResponseEntity<List<ReviewDTO.ReviewRes>> getReviewsByRoomIndex(Long roomIndex){
	...
	public ResponseEntity<List<ReviewDTO.ReviewRes>> getReviewsByUserIndex(Long userIndex){
